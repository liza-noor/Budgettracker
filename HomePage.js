...
const HomePage = () => {
  ...
  useEffect(() => {
    const getAllTransactions = async () => {
      try {
        ...
        setLoading(true);
        const res = await axios.post("http://ec2-18-216-177-222.us-east-2.compute.amazonaws.com:3001/api/v1/transections/get-transection", {
          userid: user._id,
          frequency,
          selectedDate,
          type,
  ...
  const handleDelete = async (record) => {
    try {
      setLoading(true);
      await axios.post("http://ec2-18-216-177-222.us-east-2.compute.amazonaws.com:3001/api/v1/transections/delete-transection", {
